...
class EduOfficeProfileScreen extends StatelessWidget {
  const EduOfficeProfileScreen({super.key});
          ...
          children: [
            ...
            Expanded(
              child: Column(
                ...
                children: [
                  Text(
                    userInfo?.nickname ?? userInfo?.realName ?? '管理员',
  ...
  Widget _buildSchoolInfo(userInfo) {
    return Card(
      child: Padding(
        padding: const EdgeInsets.all(16),
        child: Column(
